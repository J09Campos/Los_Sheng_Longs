...
{
    public class Tipos_InconsistenciasService : ITiposInconsistenciasService
    {
        private readonly Tipos_InconsistenciasRepository _inconsisteciasRepository;
        private readonly IBitacoraService _bitacoraService;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public Tipos_InconsistenciasService(Tipos_InconsistenciasRepository inconsisteciasRepository, IBitacoraService bitacoraService,
        ...
        public async Task<Entities.Tipos_Inconsistencia?> GetByIdAsync(string id)
        {
            return await _inconsisteciasRepository.GetByIdAsync(id);
        }
        public async Task<IEnumerable<Entities.Tipos_Inconsistencia>> GetAllAsync()
        {
            return await _inconsisteciasRepository.GetAllAsync();
        }
        public async Task<(bool Resultado, string Mensaje)> CRUDAsync(Entities.Tipos_Inconsistencia inconsistencia, string accion)
        {
            try
            {
        ...
        private bool ValidarInconsistencias(Entities.Tipos_Inconsistencia inconsistencia, string accion)
        {
